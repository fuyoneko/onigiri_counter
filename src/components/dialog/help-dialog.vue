        ...
        <v-tab-item value="tab-2">
          <v-card-text>
            ...
            <div>
              ...
              <div>
                <img width="100%" src="/images/help_check_required_count.png" />
              </div>
            ...
            <div>
              <img width="100%" src="/images/help_check_remain_count.png" />
            </div>
            ...
            <div>
              ...
              <div>
                <img width="40%" src="/images/help_switch.png" />
              </div>
              <br />
        ...
        <v-tab-item value="tab-3">
          ...
          <v-card-text>
            ...
            <div>
              ...
              >
                <image href="/images/help_onigiri_input.png" />
                <rect
                  x="10"
                  y="10"
                  width="200"
            ...
            <div>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <image href="/images/help_onigiri_input_plus.png" />
                <rect
                  x="210"
                  y="25"
                  width="90"
            ...
            <div>
              <img :width="displaySize(70, 90)" src="/images/help_onigiri_summary.png" />
            </div>
          </v-card-text>
          <v-card-text>
            ...
            <div>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <image href="/images/help_copy_button.png" />
                <rect
                  x="90"
                  y="2"
                  width="110"
            ...
            <div>
              <img :width="displaySize(70, 90)" src="/images/help_snackbar.png" />
            </div>
            <div>3. 同盟チャットで「ペースト」します</div>
            <div>
              <img :width="displaySize(70, 90)" src="/images/help_paste.png" />
            </div>
          </v-card-text>
          <v-card-text>
            ...
            <div>
              <img :width="displaySize(30, 60)" src="/images/help_reload.png" />
            </div>
          ...
          <v-card-text>
            ...
            <div>
              <img :width="displaySize(40, 70)" src="/images/help_edit_and_delete.png" />
            </div>
          ...
          <v-card-text>
            ...
            <div>
              <img :width="displaySize(20, 40)" src="/images/help_castel_switch.png" />
            </div>
            <div>2. 上部に城情報が表示され、クリップボードに登録されるようになります</div>
            <div>
              <img :width="displaySize(70, 90)" src="/images/help_castel_summary.png" />
            </div>
          </v-card-text>
          <v-card-text>
            ...
            <div>2. 「城情報設定画面」で、1分間に突破される駐屯枚数（※1）を設定します</div>
            <div>
              <img :width="displaySize(70, 90)" src="/images/help_keikoku_attack.png" />
            </div>
            <div>3. 駐屯しなければならない副将の数（※2）を設定します</div>
            <div>
              <img :width="displaySize(50, 70)" src="/images/help_defence_count.png" />
            </div>
          </v-card-text>
          <v-card-text>
            ...
            <div>
              <img :width="displaySize(70, 90)" src="/images/help_input_mode.png" />
            </div>
